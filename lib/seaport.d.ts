...
import { Asset, ComputedFees, ECSignature, EventData, EventType, FeeMethod, GasOptions, OpenSeaAPIConfig, OpenSeaAsset, OpenSeaFungibleToken, Order, OrderSide, PartialReadonlyContractAbi, UnhashedOrder, UnsignedOrder, WyvernAsset, WyvernSchemaName } from "./types";
export declare class OpenSeaPort {
     ...
     */
    fulfillOrder({ order, accountAddress, recipientAddress, referrerAddress, gasOptions, }: {
        order: Order;
        accountAddress: string;
     ...
     */
    _addGasParams(txnData: any, gasOptions?: GasOptions): any;
    /**

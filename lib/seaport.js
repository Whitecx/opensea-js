...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.fulfillOrder = function (_b) {
        var order = _b.order, accountAddress = _b.accountAddress, recipientAddress = _b.recipientAddress, referrerAddress = _b.referrerAddress, gasOptions = _b.gasOptions;
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    OpenSeaPort.prototype._addGasParams = function (txnData, gasOptions) {
    ...
    OpenSeaPort.prototype._atomicMatch = function (_b) {
        var buy = _b.buy, sell = _b.sell, accountAddress = _b.accountAddress, _c = _b.metadata, metadata = _c === void 0 ? constants_1.NULL_BLOCK_HASH : _c, gasOptions = _b.gasOptions;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 7:
                        ...
                        txnData = this._addGasParams({ from: accountAddress, value: value }, gasOptions);
                        args = [
                            [
                                buy.exchange,
                                buy.maker,
